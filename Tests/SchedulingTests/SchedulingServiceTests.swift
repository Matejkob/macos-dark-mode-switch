...
final class SchedulingServiceTests {
    ...
    func enableAutomaticSchedulingThrowsWhenPathExistsButIsNotDirectory() async {
        ...
        await #expect(throws: SchedulingError.self) {
            try await self.sut.enableAutomaticScheduling(darkModeTime: darkTime, lightModeTime: lightTime)
        }
    }
    ...
    func enableAutomaticSchedulingRegistersLaunchAgent() async throws {
        ...
        #expect(arguments?.first == "load")
        #expect(arguments?.last?.contains("com.darkmodeswitch.scheduler.plist") == true)
    }
    ...
    func disableAutomaticSchedulingThrowsWhenFileRemovalFails() async {
        ...
        await #expect(throws: TestError.self) {
            try await self.sut.disableAutomaticScheduling()
        }
    }
